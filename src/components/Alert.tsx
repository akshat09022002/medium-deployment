    ...
    if (props.success == "success") {
        return <div className="mt-3">
            <div className="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                ...
                <div>
                    <span className="font-medium">Success!</span> {props.msg}
                </div>
            </div>
        </div>
    }
    else if (props.success == "warning") {
        return <div className="mt-3">
            <div className="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800" role="alert">
                ...
                <span className="sr-only">Info</span>
                <div>
                    <span className="font-medium">Warning!</span> {props.msg}
                </div>
            </div>
        </div>
    }
    else if (props.success == "invalid") {
        return <div className="mt-3">
            <div className="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                ...
                <span className="sr-only">Info</span>
                <div>
                    <span className="font-medium">Error!</span> {props.msg}
                </div>
            </div>
